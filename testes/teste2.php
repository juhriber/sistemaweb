<?php
    ...
    $Usuario->setNomeUser('Juliana'); //Enviando Uma informação
    $Usuario->setSobreUser('Silva Ribeiro'); //Enviando Uma informação
    $Usuario->setEmailUser('j.de.s.r.25@gmail.com'); //Enviando Uma informação
